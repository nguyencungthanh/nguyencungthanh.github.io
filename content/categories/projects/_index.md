...
<svg viewBox="0 0 240 800" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- NODES -->
  <g class="nodes">
    <circle class="node-l1" cx="20" cy="350"/>
    <circle class="node-l1" cx="20" cy="375"/>
    <circle class="node-l1" cx="20" cy="400"/>
    <circle class="node-l1" cx="20" cy="425"/>
    <circle class="node-l1" cx="20" cy="450"/>
    <circle class="node-l2" cx="90" cy="287"/>
    <circle class="node-l2" cx="90" cy="312"/>
    <circle class="node-l2" cx="90" cy="337"/>
    <circle class="node-l2" cx="90" cy="362"/>
    <circle class="node-l2" cx="90" cy="387"/>
    <circle class="node-l2" cx="90" cy="412"/>
    <circle class="node-l2" cx="90" cy="437"/>
